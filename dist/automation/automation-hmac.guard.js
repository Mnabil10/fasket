...
var AutomationHmacGuard_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AutomationHmacGuard = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const hmac_util_1 = require("./hmac.util");
let AutomationHmacGuard = AutomationHmacGuard_1 = class AutomationHmacGuard {
    constructor(config) {
        this.config = config;
        this.logger = new common_1.Logger(AutomationHmacGuard_1.name);
    }
    canActivate(context) {
        ...
        if (prodLike && allowedIps.length === 0) {
            ...
            throw new common_1.ForbiddenException('IP allowlist required for automation');
        }
...
exports.AutomationHmacGuard = AutomationHmacGuard = AutomationHmacGuard_1 = __decorate([
